...
class PlayerPos(db.Model):
    ...
    def position(self) -> int:
        ...
        for i, pos in enumerate(sorted_positions):
            ...
            compare_key = (pos.win, pos.points)

            # Falls das compare_key sich ändert, müssen wir den Rang anpassen
            # (i+1, weil `i` bei 0 beginnt).
            if last_value is not None and compare_key != last_value:
                current_rank = i + 1

            rank_map[pos.id] = current_rank
